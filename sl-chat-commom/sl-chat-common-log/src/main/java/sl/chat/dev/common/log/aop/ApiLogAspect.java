package sl.chat.dev.common.log.aop;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import com.alibaba.fastjson.JSONObject;
import sl.chat.dev.common.core.utils.TPair;
import sl.chat.dev.common.log.annotation.ApiLog;
import sl.chat.dev.common.log.entity.ApiLogEntity;
...
public class ApiLogAspect {
   ...
   * 打印类或方法上的
   */
  @Around("@within(sl.chat.dev.common.log.annotation.ApiLog) "
      + "|| @annotation(sl.chat.dev.common.log.annotation.ApiLog)")
  ...
  private TPair<String, String> buildApiInfo(ProceedingJoinPoint joinPoint)
