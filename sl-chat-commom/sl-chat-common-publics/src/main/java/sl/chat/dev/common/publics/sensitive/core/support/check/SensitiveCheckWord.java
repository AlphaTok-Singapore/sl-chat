package sl.chat.dev.common.publics.sensitive.core.support.check;
...
public class SensitiveCheckWord implements ISensitiveCheck {
   ...
   * @return 实际的当前 map
   */
  private NodeTree getNowNode(NodeTree nodeTree, final WordContext context, final String txt,
      final int index) {
