package sl.chat.dev.common.publics.sensitive.core.support.handler;

import sl.chat.dev.common.publics.sensitive.common.annotation.ThreadSafe;
import sl.chat.dev.common.publics.sensitive.common.core.ISensitiveCheck;
import sl.chat.dev.common.publics.sensitive.common.core.NodeTree;
import sl.chat.dev.common.publics.sensitive.common.core.SensitiveCheckResult;
import sl.chat.dev.common.publics.sensitive.common.core.WordContext;
import sl.chat.dev.common.publics.sensitive.common.enums.ValidModeEnum;
...
import sl.chat.dev.common.publics.sensitive.core.api.IWordHandler;
import sl.chat.dev.common.publics.sensitive.core.api.IWordResult;
import sl.chat.dev.common.publics.sensitive.core.support.check.SensitiveCheckUrl;
import sl.chat.dev.common.publics.sensitive.core.support.replace.SensitiveWordReplaceContext;
import sl.chat.dev.common.publics.sensitive.core.support.result.WordResult;
...
public class SensitiveWordDefaultHandler implements IWordHandler {
  ...
  public synchronized void initWord(Collection<String> collection, WordContext wordContext) {
    ...
    log.info("敏感词初始化完成，共{}个词,加载耗时:{}/s", collection.size(),
  ...
  private String replaceSensitiveWord(final String target, final ISensitiveWordReplace replace) {
    ...
    for (int i = 0; i < target.length(); i++) {
      ...
      SensitiveCheckResult checkResult = sensitiveCheck(target, i, ValidModeEnum.FAIL_OVER,
          wordContext);
