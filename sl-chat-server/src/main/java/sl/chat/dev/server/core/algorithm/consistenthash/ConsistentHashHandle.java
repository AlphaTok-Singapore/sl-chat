package sl.chat.dev.server.core.algorithm.consistenthash;
...
import sl.chat.dev.server.tcp.listener.zk.INodeUpdateNodeEventListener;
...
public class ConsistentHashHandle implements RouteHandle, INodeUpdateNodeEventListener {
  ...
  public NodeContainer.WNode routeServer(NetProtocolEnum protocolEnum,
      List<NodeContainer.WNode> nodes, String key) {
