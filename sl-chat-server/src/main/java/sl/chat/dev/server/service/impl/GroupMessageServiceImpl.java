...
import sl.chat.dev.server.adapter.SensitiveWordAdapter;
...
import sl.chat.dev.server.mapper.GroupMessageMapper;
import sl.chat.dev.server.service.IGroupMemberService;
import sl.chat.dev.server.service.IGroupMessageService;
...
@Slf4j
@Service
public class GroupMessageServiceImpl extends
    ServiceImpl<GroupMessageMapper, GroupMessage> implements IGroupMessageService {
  ...
  public void recallMessage(Long id) {
    ...
    imClient.sendGroupMessage(userIds, msgInfo);
    log.info("撤回群聊消息，发送id:{},群聊id:{},内容:{}", userId, msg.getGroupId(),
        msg.getContent());
  }
  ...
  public void pullUnreadMessage() {
    ...
    for (GroupMember member : members) {
      ...
      log.info("拉取未读群聊消息，用户id:{},群聊id:{},数量:{}", userId, member.getGroupId(),
          messageInfos.size());
    }
